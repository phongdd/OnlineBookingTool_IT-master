...
namespace ExceltoSQLserver
{
    public partial class RefundChecking : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            string mipec_sqlCommandString = selectString + fromString + orderByString;
            string mipec_whereString = string.Empty;

            string danang_sqlCommandString = selectString + fromString + orderByString;
            string danang_whereString = string.Empty;

            string cm_sqlCommandString = selectString + fromString + orderByString;
            string cm_whereString = string.Empty;

            string tc_sqlCommandString = selectString + fromString + orderByString;
            string tc_whereString = string.Empty;

            string pvc_sqlCommandString = selectString + fromString + orderByString;
            string pvc_whereString = string.Empty;

            string htp_sqlCommandString = selectString + fromString + orderByString;
            string htp_whereString = string.Empty;

            string vinh_sqlCommandString = selectString + fromString + orderByString;
            string vinh_whereString = string.Empty;

            string hp_sqlCommandString = selectString + fromString + orderByString;
            string hp_whereString = string.Empty;

            string nvq_sqlCommandString = selectString + fromString + orderByString;
            string nvq_whereString = string.Empty;

            string tt_sqlCommandString = selectString + fromString + orderByString;
            string tt_whereString = string.Empty;

            string bmt_sqlCommandString = selectString + fromString + orderByString;
            string bmt_whereString = string.Empty;

            string LongXuyen_sqlCommandString = selectString + fromString + orderByString;
            string LongXuyen_whereString = string.Empty;

            string LinhTrung_sqlCommandString = selectString + fromString + orderByString;
            string LinhTrung_whereString = string.Empty;
